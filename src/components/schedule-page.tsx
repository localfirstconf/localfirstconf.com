  ...
  return (
    ...
    >
      ...
      <p className="mb-8 mt-8">
        The main day is on May 30, 2024. The venue is Schankhalle Pfefferberg located at <a href="https://maps.app.goo.gl/sFm1EMsFPkQAHt1b7">Schönhauser Allee 176, 10119 Berlin</a>.
      </p>
      <p className="mb-16">
        The expo day is on May 31, 2024. The venue is Gitbutler's offices, located at <a href="https://maps.app.goo.gl/xCNcnbg29AhsCwmv7">Schönhauser Allee 43a/44, 10435 Berlin</a>.
      </p>
